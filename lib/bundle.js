...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.endGame = function(ctx) {
	  ...
	  if (this.winStatus === 'win') {
	    ctx.fillText('You Win!!!', 500, 220);
	  } else {
	    ctx.fillText('You Lose...',500,220);
	  }
	  ctx.fillText('Hit Enter to play again!', 500, 350)
	  //DIM_Y / 2 - 50
	}; 
	...
	Game.prototype.draw = function (ctx) {
	  ...
	  ctx.fillText('Left, Right Arrows or A, D to move, Spacebar to fire', 50,50)
...
/***/ function(module, exports, __webpack_require__) {
	...
	Enemies.prototype.draw = function(ctx) {
	  var enemyShip = document.getElementById("enemy")
	  ctx.drawImage(enemyShip, this.pos[0], this.pos[1])
	};
